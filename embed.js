...
// Tabs
            ...
            defaultTabsArray.forEach(tab => tab.addEventListener('click', () => onClickTabHandler(defaultTabsArray,tab)));
            leftIconsTabsArray.forEach(tab => tab.addEventListener('click', () => onClickTabHandler(leftIconsTabsArray,tab)));
